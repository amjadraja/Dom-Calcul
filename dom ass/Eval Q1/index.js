...
let inpDoctor = document.querySelector('#name');
let inpDocId = document.querySelector('#doctor_id');
let inpSpecialisation = document.querySelector('#specialization');
let inpExp = document.querySelector('#experience')
let inpEmail = document.querySelector('#email');
let inpMobile = document.querySelector('#mobile')
...
myForm.addEventListener('submit', function(ele){
    ...
    data.input1 = inpDoctor.value;
    data.input2 = inpDocId.value;
    data.input3 = inpSpecialisation.value;
